...
\chapter{Réalisation du projet}
	...
	\paragraph{Demo\_CompassConfig(void)}
	est la fonction qui est appelée pendant l'initialisation du programme et qui permet de configurer correctement les différents capteurs utilisés plus tard dans le programme.\\
	...
	\paragraph{Demo\_CompassReadAcc(float* pfData) \& Demo\_CompassReadMag (float* pfData)}
	sont deux fonctions permettent de récupérer les informations des capteurs et de les stocker dans un pointer mis en paramètre. Ces fonctions permettent aussi la calibration des données en fonction du mode choisi à l'initialisation.
