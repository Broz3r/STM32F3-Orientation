...
\chapter{Reste à faire et améliorations}
	...
	\paragraph{}
	D'autre méthode pourraient être aussi implémentées, comme la méthode du filtre de Kalman ou le filtre de Madgwick qui sont des méthode notamment utilisées dans les centrales inertielles industrielles.
